 ...
 */
export function summarizeProjectContinuation(context: ProjectContextSnapshot): ProjectContinuation {
	if (context.currentTask) {
		return { kind: "current", task: summarizeTask(context.currentTask), nextStep: continuationStep(context.currentTask) };
	}
